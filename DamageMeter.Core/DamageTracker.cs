...
namespace DamageMeter
{
    public class DamageTracker
    {
        ...
        {
            if (!npcOccupierResult.HasReset) { return; }
        ...
        public void DeleteEntity(Entity entity)
        {
            ...
            if (NetworkController.Instance.Encounter == entity) { NetworkController.Instance.NewEncounter = null; }
        ...
        public void Update(SkillResult skillResult)
        {
            ...
            if (BasicTeraData.Instance.WindowData.PartyOnly &&
                (skillResult.SourcePlayer == null || !(NetworkController.Instance.PlayerTracker.MyParty(skillResult.SourcePlayer) ||
                                                       (entityTarget as NpcEntity)?.Info.HuntingZoneId == 950)) &&
                (skillResult.TargetPlayer == null || !NetworkController.Instance.PlayerTracker.MyParty(skillResult.TargetPlayer))) { return; }
