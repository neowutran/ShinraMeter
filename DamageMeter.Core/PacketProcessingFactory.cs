...
namespace DamageMeter
{
    ...
    public class PacketProcessingFactory
    {
        ...
        public void UpdateAbnormalityTracker()
        {
            ...
            { typeof(Tera.Game.Messages.SAbnormalityBegin) , new Action<Tera.Game.Messages.SAbnormalityBegin>((x)=>NetworkController.Instance.AbnormalityTracker.Update(x)) },
            { typeof(Tera.Game.Messages.SAbnormalityEnd) , new Action<Tera.Game.Messages.SAbnormalityEnd>((x)=>NetworkController.Instance.AbnormalityTracker.Update(x)) },
            { typeof(Tera.Game.Messages.SAbnormalityRefresh) , new Action<Tera.Game.Messages.SAbnormalityRefresh>((x)=>NetworkController.Instance.AbnormalityTracker.Update(x)) },
